...
require (
	...
	github.com/gwenn/gosqlite v0.0.0-20190222165041-a2186711fe00
	github.com/gwenn/yacr v0.0.0-20190406104508-cfb564bd6947 // indirect
	...
	github.com/hectane/hectane v0.3.1
